...
public interface Config {
    ...
    String MODEL_FILE = "tiny-yolo-voc-aircrafts-v2.pb";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "tiny-yolo-voc-aircrafts-labels-v2.txt"; // The filepath of label file for classes.
